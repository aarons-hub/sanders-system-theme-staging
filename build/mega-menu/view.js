...
(function () {
  document.addEventListener("DOMContentLoaded", function () {
    ...
    function updateBackdrop() {
      const anyOpen = document.querySelector('.mega-menu-button[aria-expanded="true"]');
      if (backdrop) {
        if (anyOpen) {
    ...
    document.body.addEventListener("click", function (e) {
      ...
      if (e.target && (e.target.classList.contains("theme-mega-menu-close-button") || e.target.classList.contains("menu-container__close-button"))) {
        ...
        if (mobileMenuItem) {
          var mobileButton = mobileMenuItem.querySelector(".mega-menu-button.mobile");
          if (mobileButton) {
      ...
      if (backdrop && e.target === backdrop) {
        const openButtons = document.querySelectorAll('.mega-menu-button[aria-expanded="true"]');
